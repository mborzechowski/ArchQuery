...
export default function Questions() {
    ...
    useEffect(() => {
        const labelWidth = document.querySelector(".label_questions").offsetWidth;
        document.documentElement.style.setProperty('--label-width', `${labelWidth}px`);
        const answerWidth = document.querySelector(".input_questions").getBoundingClientRect().width;
        document.documentElement.style.setProperty('--answer-width', `${answerWidth}px`);


        const myInput = document.querySelector('.input_questions');
    ...
    const GenerateQuestions = function (data) {
        ...
        return data.map((question, index) => {
            ...
            return (
                <>
                    <li className="single_question" key={index}><input className="input_questions" type="text"
                                                                       placeholder=" "/>
                        <label className="label_questions">{question}</label></li>
                </>
            )
        })
    }
